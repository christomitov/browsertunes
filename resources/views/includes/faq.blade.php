    ...
    <div class="col-12 mt40">
      <div class="faq pad20">
        <b class="bold primary-color launchaco-builder-hoverable">
          How is this different than any other music player?
        </b>
      ...
      <div class="faq pad20">
        ...
        <p class="paragraph secondary-color launchaco-builder-hoverable">
          We hope to build BrowserTunes together with our users, if you have any feature requests or find bugs, reach out to us and we'll get on it.
        </p>
      </div>
    </div>
  </div>
