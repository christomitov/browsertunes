<section id="cta-3" class="section coral-white" sitemeta="[object Object]" activepage="Landing">
  ...
  <div class="container text-center">
    <div class="col-12">
      <h4 class="heading-lrg primary-color launchaco-builder-hoverable">Hear what you've been missing.</h4>
      <div class="mt40">

        <a href="#" onclick="ga('send', 'event', 'cta_button', 'click')" target="_blank" class="button mobile-text-center mt10 launchaco-builder-hoverable primary-color mobile-text-center accent-bg fill-white">
